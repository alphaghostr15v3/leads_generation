...
<div class="row mb-3">
    <div class="col">
        <h2><i class="bi bi-people"></i> Leads Management</h2>
    </div>
    <div class="col-auto">
...
<!-- Leads Table -->
<form id="bulkDeleteForm" action="{{ route('admin.leads.bulk-delete') }}" method="POST">
    @csrf
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Leads List</h5>
            <button type="submit" id="bulkDeleteBtn" class="btn btn-danger btn-sm d-none" 
                    onclick="return confirm('Are you sure you want to delete the selected leads?')">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('admin.leads.edit', $lead) }}" class="btn btn-sm btn-warning" title="Edit">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <button type="button" class="btn btn-sm btn-danger delete-btn" 
                                                data-url="{{ route('admin.leads.destroy', $lead) }}"
                                                title="Delete">
